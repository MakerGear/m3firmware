...
#define M3_PRINTED_FILAMENT_DRIVE false
...
#define CONF_X_PULLEY  NEW_X_PULLEY
#define CONF_Y_PULLEY  NEW_X_PULLEY
...
#define CONF_EXTRUDER0_DIRECTION  M3_PRINTED_FILAMENT_DRIVE
