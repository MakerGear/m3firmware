...
#define CONF_FILAMENT_MOTOR_STEPS  		METAL_FILAMENT_MOTOR_STEPS
...
#define CONF_EXTRUDER_DIRECTION  		M3_METAL_FILAMENT_DRIVE_DIRECTION
#define CONF_EXTRUDER_MOTOR_CURRENT 	METAL_FILAMENT_MOTOR_CURRENT
